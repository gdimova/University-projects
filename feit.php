...
try {
   ...
   if(isset($_FILES['ffile'])){
      ...
      if(empty($errors)==true){
         move_uploaded_file($file_tmp,__DIR__ . "/diplomski1/".$file_name);
         //echo "Success";
      }else{
         print_r($errors);
      }
...
VALUES ('".$_POST["fname"]."','". __DIR__ ."/diplomski1/".$file_name."',2)";
if ($conn->query($sql)) {
...
<form name="feit" action="feit.php" method="post" enctype="multipart/form-data">
   ...
   if ($handle = opendir(__DIR__ .'/diplomski1/')) {
