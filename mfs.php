...
try {
   ...
   if(isset($_FILES['ffile'])){
      ...
      if(empty($errors)==true){
         move_uploaded_file($file_tmp,__DIR__ . "/diplomski2/".$file_name);
         //echo "Success";
      }else{
         print_r($errors);
      }
...
VALUES ('".$_POST["fname"]."','". __DIR__ ."/diplomski2/".$file_name."',3)";
if ($conn->query($sql)) {
...
<form name="mfs" action="mfs.php" method="post" enctype="multipart/form-data">
   ...
   if ($handle = opendir(__DIR__ .'/diplomski2/')) {
